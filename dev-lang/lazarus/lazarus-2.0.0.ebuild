...
src_install() {
	...
	dodir /etc/lazarus
	cat ${S}/tools/install/linux/environmentoptions.xml | sed -e \
	"s#__LAZARUSDIR__#$LAZARUSDIR/#" -e "s#__FPCSRCDIR__#/usr/lib/fpc/${FPCVER}/source/#" >\
	${D}/etc/lazarus/environmentoptions.xml
	...
	mv ${S}/images/icons/lazarus128x128.png ${S}/images/icons/lazarus.png
	doins ${S}/images/icons/lazarus.png
#	dodir /usr/share/applications
#	insinto /usr/share/applications
#	doins ${S}/install/lazarus.desktop
